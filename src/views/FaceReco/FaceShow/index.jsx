            ...
            <div className="box">
                <div className="boxOne" id="imgCenter">
                    ...
                    <div className="bottom">
                        <div className="bottomOne">
                            <input type="text" placeholder="&nbsp;&nbsp;&nbsp;请输入网络图片URL" className="txt" />&nbsp;&nbsp;
                            <input type="button" value="检测" className="jiance" />&nbsp;&nbsp;&nbsp;或&nbsp;&nbsp;&nbsp;
                            <input type="button" value="本地上传" className="shangchuan" />
                        </div>
                ...
                <div className="boxTwo">
                    <div className="img">
                        ...
                        <div className="item two"><img src={boy} alt="" id="img2" /></div>
                        <div className="item three"><img src={family} alt="" id="img3" /></div>
                        <div className="item four"><img src={work} alt="" id="img4" /></div>
                    </div>
