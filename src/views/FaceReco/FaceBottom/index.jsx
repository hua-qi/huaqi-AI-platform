                    ...
                    >
                        ...
                        <div className='boxOne boxTwo boxThree'>
                            ...
                            <span className='content'>
                                ...
                                <span className='contentxt'>
                                    可对SDK进行二次开发，灵活调整业务代码，实现不同的业务功能
                                </span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className='box'>
                        <div className='boxOne'>
                            <span className='content'>
                                ...
                                <span className='contentxt'>
                                    集成到单台硬件设备中，实现人脸检测、人脸关键点采集、在设备端离线完成从静态图片、视频流中检测并捕获人脸功能
                                </span>
                            </span>
                        </div>
                        <div className='boxTwo'>
                            <span className='content'>
                                ...
                                >
                                    提供一体机和软件部署包两种私有化方案
                                    ，在本地服务器部署后，实现图片中的人脸检测、关键点定位和属性识别功能，支持分布式高并发业务处理，适用于安防、监控等场景
                                </span>
                            </span>
                        </div>
                    </div>
